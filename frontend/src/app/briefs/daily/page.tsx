          ...
          <div className="space-y-3 text-xs">
            {bestCamp ? (
              <div className="space-y-3">
                <div className="flex flex-col border-b border-slate-50 pb-3 gap-1">
                  <div className="flex justify-between items-center">
                    <span className="font-semibold text-slate-500 uppercase text-[9px]">🥇 Best Performing Campaign</span>
                    <span className="font-bold text-slate-800 text-xs truncate max-w-[200px]">{bestCamp.name}</span>
                  </div>
                  <p className="text-[10px] text-slate-500 mt-0.5 leading-relaxed font-semibold">
                    Generated <span className="font-extrabold text-slate-800">{bestCamp.value} {bestCamp.metric}</span> at a low cost of <span className="font-extrabold text-slate-800">₹{bestCamp.cost.toFixed(2)}</span> per result yesterday.
                  </p>
                ...
                {/* 25+ years experience marketer insights */}
              ...
              <div className="text-[10px] text-slate-400 text-center py-4">No active campaign metrics today.</div>
            )}
          </div>
        </div>
