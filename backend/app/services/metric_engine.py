...
METRIC_CATALOG: Dict[str, Dict[str, Any]] = {
    ...
    "cost_per_outbound_click": {
        "metric_name": "cost_per_outbound_click",
    ...
    "cost_per_add_to_cart": {
        "metric_name": "cost_per_add_to_cart",
    ...
    "cost_per_initiate_checkout": {
        "metric_name": "cost_per_initiate_checkout",
    ...
    "budget_utilization_percentage": {
        "metric_name": "budget_utilization_percentage",
