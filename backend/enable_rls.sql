...
-- Additional tables with RLS Disabled in Public Security Advisor warnings
ALTER TABLE IF EXISTS public.campaign_plans ENABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS public.admin_configs ENABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS public.ai_usage_records ENABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS public.funnel_events ENABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS public.funnel_audits ENABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS public.funnel_recommendations ENABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS public.ad_packs ENABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS public.meta_ad_service_requests ENABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS public.service_quotations ENABLE ROW LEVEL SECURITY;
